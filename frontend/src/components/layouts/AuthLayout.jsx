...
import { LuTrendingUpDown } from "react-icons/lu"; // Ensure it's installed
// import StatsInfoCard from "../StatsInfoCard"; // Ensure this file exists
    ...
    <div className="flex gap-6 bg-white p-4 rounded-xl shadow-md shadow-purple-400/10 border border-gray-200/50 z-10">
      <div
        ...
        <div>
          ...
          <span className="text-[2opx]">${value}</span>
        </div>
    </div>
  )
}
